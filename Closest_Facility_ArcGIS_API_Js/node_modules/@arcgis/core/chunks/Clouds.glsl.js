...
*/
import{glsl as t}from"../views/3d/webgl-engine/core/shaderModules/interfaces.js";import{ShaderBuilder as e}from"../views/3d/webgl-engine/core/shaderModules/ShaderBuilder.js";function n(){const n=new e;return n.attributes.add("position","vec3"),n.fragment.uniforms.add("cloudRadius","float").add("halfCubeMapSize","float").add("power","float").add("sigmaE","float").add("density","float").add("cloudSize","float").add("detailSize","float").add("smoothness","float").add("cloudHeight","float").add("coverage","float").add("viewMatrix","mat3").add("cloudShapeTexture","sampler2D"),n.vertex.code.add(t`void main(void) {
gl_Position = vec4(position, 1.0);
}`),n.fragment.code.add(t`const int STEPS = 200;
