...
return stretchedVal;
}`);const t=e.applyColormap?l`gl_FragColor = colormap(vec4(grayVal, grayVal, grayVal, currentPixel.a), !u_useGamma);`:l`gl_FragColor = vec4(grayVal, grayVal, grayVal, 1.0) * currentPixel.a * u_opacity;`;a.fragment.code.add(l`
      void main() {
        vec2 pixelLocation = getPixelLocation(v_texcoord);
        if (isOutside(pixelLocation)) {
          gl_FragColor = vec4(0.0, 0.0, 0.0, 0.0);
        ...
        vec4 currentPixel = getPixel(pixelLocation);
        ${0===e.stretchType?l`
        gl_FragColor = vec4(currentPixel.rgb, 1.0) * currentPixel.a * u_opacity;`:l`
...
}`);const t=e.applyColormap?l`gl_FragColor = overlay(ve.r, u_minValue, u_maxValue, hillshade, alpha);`:l`hillshade *= alpha;
