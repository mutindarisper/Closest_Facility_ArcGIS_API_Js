...
const CalciteExpandToggle = require('./CalciteExpandToggle-14f33bbd.js');
const dom = require('./dom-57231db9.js');
const resources = require('./resources-76637167.js');
const resources$1 = require('./resources-ae299e51.js');
...
const CalciteActionBar = class {
  ...
  renderBottomActionGroup() {
    ...
    const expandToggleNode = !expandDisabled ? (index.h(CalciteExpandToggle.CalciteExpandToggle, { el: el, expanded: expanded, intlCollapse: collapseLabel, intlExpand: expandLabel, position: position, ref: this.setExpandToggleRef, toggle: toggleExpand, tooltip: tooltip })) : null;
    return dom.getSlotted(el, SLOTS.bottomActions) || expandToggleNode ? (index.h("calcite-action-group", { class: CSS.actionGroupBottom }, index.h("slot", { name: SLOTS.bottomActions }), index.h("slot", { name: SLOTS.expandTooltip }), expandToggleNode)) : null;
  }
  render() {
