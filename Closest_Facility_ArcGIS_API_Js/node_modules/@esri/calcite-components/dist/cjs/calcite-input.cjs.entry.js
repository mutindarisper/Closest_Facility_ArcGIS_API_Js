...
const CalciteInput = class {
  constructor(hostRef) {
    ...
    this.inputNumberKeyDownHandler = (event) => {
      ...
      if (event.key === decimalSeparator &&
        (this.step === "any" || (this.step && number.isValidDecimal(this.step)))) {
  ...
  render() {
    ...
    const numberButtonsHorizontalUp = (index.h("button", { class: {
      ...
      }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onClick: this.numberButtonClickHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: "s" })));
    const numberButtonsHorizontalDown = (index.h("button", { class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton
      }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onClick: this.numberButtonClickHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: "s" })));
