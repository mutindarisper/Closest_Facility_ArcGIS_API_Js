...
const CalciteListItem = class {
  ...
  renderContentContainer() {
    ...
    return !nonInteractive ? (index.h("button", { class: { [CSS$1.contentContainer]: true, [CSS$1.contentContainerButton]: true }, disabled: disabled }, content)) : (index.h("div", { class: CSS$1.contentContainer }, content));
  }
  render() {
