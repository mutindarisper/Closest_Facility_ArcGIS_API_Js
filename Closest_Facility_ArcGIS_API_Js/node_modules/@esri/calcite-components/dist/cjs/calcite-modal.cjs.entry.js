...
const CalciteModal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("calcite-scrim", { class: "scrim", onClick: this.handleOutsideClose }), this.renderStyle(), index.h("div", { class: { modal: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" }, onTransitionEnd: this.transitionEnd }, index.h("div", { "data-focus-fence": true, onFocus: this.focusLastElement, tabindex: "0" }), index.h("div", { class: "header" }, this.renderCloseButton(), index.h("header", { class: "title" }, index.h("slot", { name: "header" }))), index.h("div", { class: {
        content: true,
