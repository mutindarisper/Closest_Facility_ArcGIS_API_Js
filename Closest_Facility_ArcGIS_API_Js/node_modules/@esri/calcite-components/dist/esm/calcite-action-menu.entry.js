...
import { C as CSS, I as ICONS, S as SLOTS } from './resources-82817f70.js';
...
const CalciteActionMenu = class {
  ...
  renderMenuButton() {
    const { el, label } = this;
    const menuButtonSlot = (h("slot", { name: SLOTS.trigger }, h("calcite-action", { class: CSS.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, text: label })));
