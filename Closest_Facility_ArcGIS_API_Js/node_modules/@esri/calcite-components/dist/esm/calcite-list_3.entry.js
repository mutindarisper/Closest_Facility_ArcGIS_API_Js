...
const CalciteListItem = class {
  ...
  renderContentContainer() {
    ...
    return !nonInteractive ? (h("button", { class: { [CSS$1.contentContainer]: true, [CSS$1.contentContainerButton]: true }, disabled: disabled }, content)) : (h("div", { class: CSS$1.contentContainer }, content));
  }
  render() {
