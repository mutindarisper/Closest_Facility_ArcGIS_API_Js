...
import { f as focusElement, n as nodeListToArray, a as getSlotted, g as getElementDir, C as CSS_UTILITY, l as filterDirectChildren } from './dom-0b02c0cf.js';
...
const CalciteTreeItem = class {
  ...
  render() {
    ...
    const checkbox = this.inputEnabled ? (h("label", { class: CSS.checkboxLabel }, h("calcite-checkbox", { checked: this.selected, class: CSS.checkbox, "data-test-id": "checkbox", indeterminate: this.hasChildren && this.indeterminate, scale: this.scale, tabIndex: -1 }), h("slot", null))) : null;
    ...
    return (h(Host, { "aria-expanded": this.hasChildren ? this.expanded.toString() : undefined, "aria-hidden": hidden.toString(), "aria-selected": this.selected
        ...
        [CSS_UTILITY.rtl]: rtl
      }, ref: (el) => (this.defaultSlotWrapper = el) }, icon, checkbox ? checkbox : h("slot", null)), h("div", { class: {
        [CSS.childrenContainer]: true,
        [CSS_UTILITY.rtl]: rtl
      }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, ref: (el) => (this.childrenSlotWrapper = el), role: this.hasChildren ? "group" : undefined }, h("slot", { name: "children" }))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
